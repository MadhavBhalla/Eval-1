                ...
                <div className="container-xl">
                    <div className="boxa">
                        <div className="col-md-12">
                            ...
                            <h6 className="boxc">
                                <a className="b" href="index.html">Home &nbsp;|</a>&nbsp;About Us
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-xl">
                    <div className="row overview_1">
                        <div className="col-md-6">
                            ...
                            <h6 className="mb-0">
                                <a href="ourteam.html" className="button22">About Our Team <i className="fa fa-long-arrow-right ms-1"></i></a>
                            </h6>
                        </div>
                        <div className="col-md-6">
                            <div className="overview-right">
                                <div className="grid clearfix">
                                    <figure className="effects">
                                        <a href="#"><img src="images/about/img3.jpg" alt="img3" /></a>
                                    </figure>
                                </div>
                            </div>
                        </div>
                ...
                <div className="row feature_1">
                    ...
                    <div className="col-md-6 px-0">
                        <div className="feature_1r">
                            <div className="grid clearfix">
                                <figure className="effects">
                                    <a href="#"><img src="images/about/best.jpg" alt="Feature" className="img-fluid" /></a>
                                </figure>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-xl">
                ...
                {[
                        ...
                        <div className="col-md-3 col-sm-6 mb-4" key={index}>
                            ...
                            <div className="mt-3">
                                <h5><a className="ko" href="#">{item.title}</a></h5>
