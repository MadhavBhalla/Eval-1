    ...
    <div className="container">
      <div className="content">
        ...
        <section id="about_course">
          ...
          <p>Computer Science and Engineering (CSE) involves the design, development, and application of computer systems and software. It covers a wide range of computing technologies and applications, from data processing to artificial intelligence and networking.</p>
        </section>

        <section id="benefits">
          <h2>Benefits of the Course</h2>
          <ul>
            <li>High demand for skilled professionals in various industries</li>
            <li>Opportunities for innovation and creativity in solving real-world problems</li>
        ...
        <section id="future-opportunities">
          ...
          <p>The field of CSE continues to grow with advancements in technology like Artificial Intelligence (AI), Machine Learning, Internet of Things (IoT), Blockchain, and more. Professionals with expertise in these areas are highly sought after by tech giants and startups alike.</p>
        </section>

        <section id="job-opportunities">
          <h2>Job Opportunities</h2>
          <p>Currently, there are thousands of job opportunities available for CSE graduates globally. Key roles include software developer, system analyst, network engineer, data scientist, AI specialist, and many others.</p>
        </section>
      </div>
    </div>
  );
            ...
            <div className="course_1m clearfix">
              <div className="course_1m1 clearfix position-relative">
                <div className="course_1m1i clearfix">
                  <div className="grid clearfix">
                    <figure className="effect-jazz mb-0">
                      <a href="#"><img src="images/course/img_13.jpg" className="w-110" alt="Stanford" /></a>
                    </figure>
                  </div>
                </div>
              </div>
  ...
  return (
    <div>
      ...
      <div className="video-container">
        ...
        <iframe src="https://www.youtube.com/embed/5xKmg5T7oQ8" allowFullScreen></iframe>
      </div>
      <div className="video-container">
        <h3>Careers in CSE</h3>
        <iframe src="https://www.youtube.com/embed/yUaJCjiPBnY" allowFullScreen></iframe>
      </div>
      <div className="video-container">
      ...
      <div className="video-container">
        ...
        <iframe src="https://www.youtube.com/embed/rzO3i_fCXNE" allowFullScreen></iframe>
      </div>
      <br />
      <div>
